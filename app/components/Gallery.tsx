        ...
        {images.map((image, index) => (
          ...
          >
            <img
              src={image.src}
              alt={image.alt}
              className="w-[100px] sm:w-[139px] rounded-sm sm:rounded-lg transition-transform duration-300 hover:scale-105"
              loading="lazy"
            />
          </motion.div>
        ))}
          ...
          >
            ...
            >
              <button
                ...
                className="absolute -top-12 right-4 text-white p-2 rounded-full hover:bg-white/10 transition-colors"
                aria-label="Close"
              >
                <X className="w-6 h-6" />
              </button>
